@extends('layouts.app')
@section('title','Approving Confirm')
...
<div class="container">
  <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">ยืนยันลบคำขอ</li>
    </ol>
  </nav>
  <form action="/admin/topup/approve/con" method="POST">
    @csrf
  <div class="row bg-light p-2 border text-center">
   <h2 style="color:red;">คุณต้องการยืนยันคำขอนี้ใช่หรือไม่</h2>
